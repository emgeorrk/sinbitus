...
type (
	...
	HabitUseCase interface {
		CreateHabit(ctx context.Context, userID uint64, name, description string) (*entity.Habit, error)
		UpdateHabit(ctx context.Context, userID, habitID uint64, name, description *string) (*entity.Habit, error)
